...
private:
	...
	QString                    m_qorignialimagetransform, m_qupdateimagetransform;
	QString	                   m_qOrignialimageEnhance,m_qupdateimageEnhance;
	String                     m_orignialimagetransform, m_updateimagetransform;
	String	                   m_OrignialimageEnhance, m_updateimageEnhance;
