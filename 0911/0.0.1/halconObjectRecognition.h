...
public:
	...
	void                     setUpModel(HObject  ho_ModelImage, int m_iCurrentFlag, int m_iCurrentImgId);
	void                     upDateNewData(HObject  ho_ModelImage, int m_iCurrentRoi_X, int m_iCurrentRoi_Y, int m_iCurrentCols, int m_iCurrentRows, int m_iCurrentImgId);
